...
namespace MaterialCore.DataSets {
    ...
    public partial class Bitacora : global::System.Data.DataSet {
        ...
        public partial class MaterialesBitacoraDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public MaterialesBitacoraRow AddMaterialesBitacoraRow(int id, int nid_usuario, System.DateTime fecha, string Tipo, string Movimiento, int IdPartida, int PO, int Linea, string NoGuia, string info) {
        ...
        public partial class MaterialesBitacoraRow : global::System.Data.DataRow {
            ...
            public int PO {
                get {
                    try {
                        return ((int)(this[this.tableMaterialesBitacora.POColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
SELECT id, nid_usuario, fecha, Tipo, Movimiento, IdPartida, PO, Linea, NoGuia, info FROM MaterialesBitacora WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PO", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "PO", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int InsertQuery(int nid_usuario, string Tipo, string Movimiento, global::System.Nullable<int> IdPartida, global::System.Nullable<int> PO, global::System.Nullable<int> Linea, string NoGuia, string info) {
            ...
            if ((PO.HasValue == true)) {
                command.Parameters[4].Value = ((int)(PO.Value));
            }
            else {
