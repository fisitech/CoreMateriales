    ...
    public partial class Embarques : global::System.Data.DataSet {
        ...
        public partial class MaterialesEnviarRow : global::System.Data.DataRow {
            ...
            public string Comentario {
                get {
                    try {
                        return ((string)(this[this.tableMaterialesEnviar.ComentarioColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Comentario\' in table \'MaterialesEnviar\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableMaterialesEnviar.ComentarioColumn] = value;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public bool IsComentarioNull() {
                return this.IsNull(this.tableMaterialesEnviar.ComentarioColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public void SetComentarioNull() {
                this[this.tableMaterialesEnviar.ComentarioColumn] = global::System.Convert.DBNull;
            }
        }
        ...
        public partial class PartidasDespachadasRow : global::System.Data.DataRow {
            ...
            public string NoGuia {
                get {
                    try {
                        return ((string)(this[this.tablePartidasDespachadas.NoGuiaColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'NoGuia\' in table \'PartidasDespachadas\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePartidasDespachadas.NoGuiaColumn] = value;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public bool IsNoGuiaNull() {
                return this.IsNull(this.tablePartidasDespachadas.NoGuiaColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public void SetNoGuiaNull() {
                this[this.tablePartidasDespachadas.NoGuiaColumn] = global::System.Convert.DBNull;
            }
        }
...
ORDER BY MaterialesPaltetas.Id DESC";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(System.DateTime FechaRecibo, string NumeroPaleta, string Planta, global::System.Nullable<decimal> PesoBruto, global::System.Nullable<decimal> CantidadBultos, string TipoEmbarque, string ContenidoTipoBulto, global::System.Nullable<global::System.DateTime> FechaEmbarque, global::System.Nullable<int> ConsecutivoEmbarque, string NombrePaleta, string nid_sku, global::System.Nullable<int> Consecutivo) {
            ...
            if ((Consecutivo.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[11].Value = ((int)(Consecutivo.Value));
            }
            else {
    ...
    public partial class PartidasDespachadasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT     MaterialesEnviar.Fecha AS Fechallegada, MaterialesPaltetas.Consecutivo" +
                ...
                "      MaterialesEnviar.NoGuia\r\nFROM         MaterialesPaltetas INNER JOIN\r\n     " +
                "                 deploys ON MaterialesPaltetas.ConsecutivoEmbarque = deploys.nid" +
                "_deploy INNER JOIN\r\n                      MaterialesEnviar ON MaterialesPaltetas" +
                ".Id = MaterialesEnviar.MaterialesPaletasId INNER JOIN\r\n                      car" +
                "riers_deploys ON deploys.nid_deploy = carriers_deploys.nid_deploy LEFT OUTER JOI" +
                "N\r\n                      sku_escanear ON MaterialesEnviar.NoGuia = sku_escanear." +
                "nid_sku\r\nWHERE     (MaterialesEnviar.NoGuia LIKE @noGuia) AND (MaterialesEnviar." +
                "MaterialesOCId LIKE @PO) AND (MaterialesEnviar.RenglonId LIKE @Linea) AND \r\n    " +
                "                  (carriers_deploys.cbox_number LIKE @Caja) AND (MaterialesEnvia" +
                "r.NumeroParte LIKE @NumParte) AND (MaterialesEnviar.Fecha BETWEEN \r\n            " +
                "          DATEADD(MONTH, - 1, GETDATE()) AND DATEADD(day, 1, GETDATE())) AND (Ma" +
                "terialesPaltetas.ConsecutivoEmbarque LIKE @Embarque) AND \r\n                     " +
